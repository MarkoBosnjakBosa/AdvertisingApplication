	...
	<head>
		...
		<script type="text/javascript">
			$(document).on('submit', '#forgot_password_form', function(e){
				...
				var email = $("#email").val();
				$.ajax({
					url: "handlers/forgot_password_handler.php",
					method: "POST",
					data: {email : email},
					dataType: "html",
					beforeSend: function() { 
						$("#forgot_password_button").html("Sending...");
			...
			<div class="form_box">
				<div class="form_top">
					<div class="form_top_left">
						...
						<p>Enter your email address in order to receive your password:</p>
					</div>
				...
				<div class="form_bottom">
					<form id="forgot_password_form" method="POST">
						<div class="form-group">
							<input type="email" name="email" class="form-control email_forgot_password" id="email" placeholder="Email..." required>
						</div>
						<div class="form-row">
							<div class="col-sm">
								<button class="btn btn-lg btn-primary btn-block" id="forgot_password_button" type="submit">Submit</button>
							</div>
						</div>
					</form>
				</div>
