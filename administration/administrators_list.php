		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				function displayAdministrators(){
					$.ajax({
						url: "displays/display_administrators.php",
						method: "GET",
						dataType: "html",
						success: function(data){
							$("#display_administrators").html(data);
						}
					})
				}
				$(document).on('click', '#delete_administrator_button', function(){
					var id = $(this).val();
					$.ajax({
						url: "deletions/delete_administrator.php",
						method: "POST",
						data: {id : id},
						dataType: "html",
						success: function(data){
							$("#delete_administrator_message").html(data);
							displayAdministrators();
						}
					})
				})
	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs justify-content-center">
				<li class="nav-item">
					<a class="nav-link active" href="administrators_list.php">Administrators</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="register_administrator.php">Registration</a>
				</li>
			</ul>
		</div>
		<div class="container">
			<div id="delete_administrator_message"></div>
			<div id="display_administrators"></div>
		</div>
	</body>
</html>