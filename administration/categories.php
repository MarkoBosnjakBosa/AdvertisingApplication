...
<html>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$(document).on('submit', '#category_form', function(e){
					...
					$.ajax({
						url: "submissions/submit_category.php",
						method: "POST",
						data: {category : category},
						dataType: "html",
						success: function(data){
							$("#submit_category_message").html(data);
							displayCategories();
				...
				$(document).on('click', '#delete_category_button', function(){
					var id = $(this).val();
					$.ajax({
						url: "deletions/delete_category.php",
						method: "POST",
						data: {id : id},
						dataType: "html",
						success: function(data){
							$("#delete_category_message").html(data);
							displayCategories();
						}
					})
				})
	...
	<body>
		...
		<div class="container" id="categories_container">
			<div id="submit_category_message"></div>
			<form id="category_form" method="POST">
				<div class="form-group row text-center">
					<label for="category" class="col-sm-2 col-form-label">Enter a category:</label>
					<div class="col-sm-6">
			...
			<hr/>
			<div id="delete_category_message"></div>
