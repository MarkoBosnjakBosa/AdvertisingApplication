	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				function displayAds(){
					$.ajax({
						url: "displays/admin_display_ads.php",
						method: "GET",
						dataType: "html",
				...
				$(document).on('click', '#delete_ad_button', function(){
					var id = $(this).val();
					$.ajax({
						url: "deletions/admin_delete_ad.php",
						method: "POST",
						data: {id : id},
						dataType: "html",
						success: function(data){
							$("#delete_ad_message").html(data);
							displayAds();
						}
					})
				})
	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs justify-content-center">
				<li class="nav-item">
					<a class="nav-link active" href="ads_list.php">All ads</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="user_ads_list.php">Ads by user</a>
				</li>
			</ul>
		</div>
		<div class="container-fluid">
			<div id="delete_ad_message"></div>
