		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-10">
					...
					<div class="container">
					<?php
						if(isset($_GET['inquiry']) && !empty($_GET['inquiry'])){
							$inquiry = mysqli_real_escape_string($link, $_GET['inquiry']); 
						...
						?>
									<div class="container">
										<div class="card">
											...
											<div class="card-body"><?php echo $fetch_result['description']; ?></div>
											<div class="card-footer">
												<div class="row">
													<div class="col-sm-6">
														<a class="btn btn-info" href="view_ad.php?id=<?php echo $fetch_result['id']; ?>" role="button">Detailed</a>
													</div>
													<div class="col-sm-6" style="text-align: right">
