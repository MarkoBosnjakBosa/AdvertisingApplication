			...
			$(document).ready(function(){
				...
				$(document).on('submit', '#comments_form', function(e){
					...
					$.ajax({
						...
						method: "POST",
						data: {mother_id : mother_id, content : content, username : username, ad_id : ad_id},
						dataType: "html",
						beforeSend: function(){ 
	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs justify-content-center">
				...
				<li class="nav-item">
					<a class="nav-link active" href="questions.php?ad_id=<?php echo $fetch_result['id']; ?>">Comments</a>
				</li>
			</ul>
		</div>
		<div class="container">
