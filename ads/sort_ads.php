...
if(isset($_POST) && !empty($_POST)){
	...
	$query = "SELECT * FROM ads WHERE `price` >= '$price_from' AND `price` <= '$price_to' AND `city` = '$city' AND `condition` = '$condition' ORDER BY `id` DESC";
	if($condition == "all"){
		if($city == "all"){
			$query = "SELECT * FROM ads WHERE `price` >= '$price_from' AND `price` <= '$price_to' ORDER BY `id` DESC";
		}
		else{
			$query = "SELECT * FROM ads WHERE `price` >= '$price_from' AND `price` <= '$price_to' AND `city` = '$city' ORDER BY `id` DESC";
		}
	}
	if($city == "all"){
		if($condition == "all"){
			...
			$query = "SELECT * FROM ads WHERE `price` >= '$price_from' AND `price` <= '$price_to' AND `condition` = '$condition' ORDER BY `id` DESC";
		}
	}
}
				...
				<div class="col-sm-2">
					...
					<div class="collapse" id="collapsePrimjer">
						<div class="card card-body">
							<form id="sort_form" action="sort_ads.php" method="POST">
